...
void startWiFiConfigPortal() {
  ...
  if (!wm.autoConnect("Node-Anggrek2", "password")) {
...
void setup() {
  ...
  lcd.setCursor(0, 1);
  lcd.print("Node Anggrek2");
  delay(2000);
  lcd.clear();
  Serial.println("Letsgo!");

  dht.begin();
  Serial.println("Go to LUX!");

  myLux.begin();
  Serial.println("After LUX!");
