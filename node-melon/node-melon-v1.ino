...
#define SOIL_SENSOR_PIN 35  // Use GPIO 32 (ADC1)
int dry = 3510;
int wet = 150;
...
void loop() {
  ...
  int moisture = map(constrain(moistureRaw, wet, dry), dry, wet, 0, 100);
  ...
  lcd.setCursor(0, 1);
  lcd.print("L:"); lcd.print(lux); lcd.print("lx");
  lcd.setCursor(11, 1);
  lcd.print("Soil "); lcd.print(moisture); lcd.print("% ");
